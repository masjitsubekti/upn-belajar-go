...
type Config struct {
	App struct {
		...
		File struct {
			...
			ItemImage             string `mapstructure:"ITEM_IMAGE"`
			LogBookMagang         string `mapstructure:"LOG_BOOK_MAGANG"`
			LuaranMagang          string `mapstructure:"LUARAN_MAGANG"`
			NilaiMagang           string `mapstructure:"NILAI_MAGANG"`
			BuktiPenerimaanMagang string `mapstructure:"BUKTI_PENERIMAAN_MAGANG"`
		}
